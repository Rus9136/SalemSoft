...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-12 items-center justify-center rounded-xl bg-surface/50 p-1 text-muted-foreground border border-line',
      className
    )}
    {...props}
  />
