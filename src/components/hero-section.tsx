        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <h1 className="text-display-1 lg:text-6xl xl:text-7xl font-heading font-black text-fg mb-6 leading-tight">
              Сопровождение{' '}
              <span className="gradient-text">и внедрение</span>{' '}
              1С под ключ
            </h1>
            
            <p className="text-lead text-fg-muted mb-8 max-w-lg leading-relaxed">
              Мы — официальный франчайзи 1С. Настраиваем, обновляем и поддерживаем 1С:Бухгалтерию, 1С:Торговлю и другие конфигурации под ваш бизнес.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 text-sm">
              <span className="text-fg-muted">Срочно нужна помощь с 1С?</span>
            ...
            <div className="relative">
              ...
              <div className="relative glass-effect rounded-3xl p-8 glow-effect">
                <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-between">
                    <h3 className="text-lg font-semibold text-fg">1С:Предприятие</h3>
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    <div className="text-center">
                      ...
                      <div className="text-xs text-fg-muted">Скорость учёта</div>
                    </div>
                    <div className="text-center">
                      <div className="text-2xl font-bold text-success">-80%</div>
                      <div className="text-xs text-fg-muted">Ошибки</div>
                    </div>
                    <div className="text-center">
                      <div className="text-2xl font-bold text-fg">24/7</div>
                      <div className="text-xs text-fg-muted">Поддержка</div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-3">
                    {[
                      { label: 'Учёт и отчётность', progress: 95, color: 'bg-accent' },
                      { label: 'Автоматизация', progress: 92, color: 'bg-success' },
                      { label: 'Интеграции', progress: 88, color: 'bg-amber-400' },
                    ].map((item, index) => (
              ...
              <div className="absolute -top-4 -right-4 glass-effect rounded-xl p-4 animate-glow">
                <div className="text-center">
                  ...
                  <div className="text-xs text-fg-muted">Время отчётов</div>
                </div>
              </div>
              ...
              <div className="absolute -bottom-4 -left-4 glass-effect rounded-xl p-4">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs text-fg-muted">1С обновлена</span>
                </div>
              </div>
            </div>
          </div>
