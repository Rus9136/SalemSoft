          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="text-fg-muted mb-6 max-w-md leading-relaxed">
                Мы официальные франчайзи 1С. Помогаем компаниям в Казахстане автоматизировать бухгалтерский учёт, торговлю и управление. Обеспечиваем надёжную поддержку и развитие ваших информационных систем.
              </p>
