...
export const metadata: Metadata = {
  ...
  description: 'Команда экспертов по внедрению CRM систем. 10+ лет опыта, 50+ успешных проектов.',
}
...
const faq = [
  {
    question: 'Какой у вас опыт работы с CRM системами?',
    answer: 'Наша команда имеет более 10 лет опыта в разработке и внедрении CRM систем. Мы реализовали более 50 проектов в различных отраслях: от e-commerce до производства.'
  },
  {
      ...
      <section className="section-padding bg-gradient-to-br from-accent/5 via-bg to-bg">
        <div className="container">
          <SectionHeading
            ...
            description="Команда профессионалов с 10+ летним опытом в разработке и внедрении CRM систем. Помогаем бизнесу расти через технологии."
            centered
            className="mb-16"
          />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
            <div>
              ...
              <p className="text-fg-muted leading-relaxed">
                ...
                Мы не просто разрабатываем CRM системы, мы создаем инструменты для роста бизнеса.
              </p>
            </div>
